        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="float-end">
                        <a href="{{ route('users.index') }}" class="btn btn-outline-dark btn-sm">&larr; Voltar</a>
                    </div>
                </div>
                <div class="card-body">
                    ...
                    <div class="mb-3 row">
                        <label for="roles" class="col-md-4 col-form-label text-md-end text-start"><strong>Papeis:</strong></label>
                        <div class="col-md-6" style="line-height: 35px;">
