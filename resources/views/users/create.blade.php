            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('users.store') }}" method="post">
                        ...
                        <div class="mb-3 row">
                            <label for="password_confirmation" class="col-md-4 col-form-label text-md-end text-start">Confirme sua Senha</label>
                            <div class="col-md-6">
                        ...
                        <div class="mb-3 row">
                            <label for="roles" class="col-md-4 col-form-label text-md-end text-start">Papeis</label>
                            <div class="col-md-6">
